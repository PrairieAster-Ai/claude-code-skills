...
| [**code-readability**](skills/code-readability/) | Enforce a TSDoc-native comment standard that serves humans, IDEs, doc generators, and AI at once, then generate + publish cross-linked API docs to a GitHub Wiki. | `/code-readability [assess\|annotate\|generate\|publish] [path]` |
